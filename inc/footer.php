          ...
          <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ms-lg-auto">
              <ul class="list-inline list-inline-dots mb-0">
                <li class="list-inline-item"><a href="https://github.com/munzirulalom/task-management-system" target="_blank" class="link-secondary" rel="noopener">Source code</a></li>
              </ul>
            </div>
